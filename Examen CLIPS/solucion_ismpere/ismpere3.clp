...
(deffacts hechos "Hechos de la memoria de trabajo"
	(oavc-u (objeto nivel-vaso-difusor) (atributo desviacion) (valor 30) (factor 1.0))
	(oavc-u (objeto nivel-vaso-difusor) (atributo incremento) (valor 11) (factor 1.0))
	...
	(oavc-u (objeto caudal-extraccion) (atributo valor) (valor bajo) (factor 1.0))
)
